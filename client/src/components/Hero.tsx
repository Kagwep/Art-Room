    ...
    <section className="h-[1250px] bg-hero bg-no-repeat bg-cover bg-center py-20">
      <div className="container mx-auto flex justify-around h-full items-center">
        ...
        <div className="text-center">
          ...
          <Link to={'/galleries'} className='inline-block uppercase font-semibold border-b-2 border-primary text-primary hover:text-cyan-700 transition duration-300 ease-in-out py-1'>Explore Now</Link>
        </div>
      </div>
    </section>
